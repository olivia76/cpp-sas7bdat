...
namespace pycppsas7bdat {
  ...
  struct SinkChunk : public SinkBase {
    ...
    template<typename _Values>
    static void clear_values(_Values& _values)
    {
    ...
    {
      set_dict_values(_d, columns.numbers, col_numbers, [](const cppsas7bdat::Column& _col, auto& _values) { return SinkChunk::to_nparray_obj(_values/*, NPY_DOUBLE*/); });
      set_dict_values(_d, columns.integers, col_integers, [](const cppsas7bdat::Column& _col, auto& _values) { return SinkChunk::to_nparray_obj(_values/*, NPY_LONG*/); });
      set_dict_values(_d, columns.datetimes, col_datetimes, [](const cppsas7bdat::Column& _col, auto& _values) { return SinkChunk::to_nparray_obj(_values/*, NPY_DATETIME*/); });
      set_dict_values(_d, columns.dates, col_dates, [](const cppsas7bdat::Column& _col, auto& _values) { return SinkChunk::to_nparray_obj(_values/*, NPY_DATE*/); });
      set_dict_values(_d, columns.times, col_times, [](const cppsas7bdat::Column& _col, auto& _values) { return SinkChunk::to_nparray_obj(_values/*, NPY_TIME*/); });
      set_dict_values(_d, columns.strings, col_strings, [](const cppsas7bdat::Column& _col, auto& _values) { return SinkChunk::to_nparray_obj(/*_col.length(),*/_values); });
    }
