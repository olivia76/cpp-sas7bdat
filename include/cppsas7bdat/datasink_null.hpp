...
namespace cppsas7bdat {
  namespace datasink {
	...
	for(const auto& column: columns) {
	  ...
	  case cppsas7bdat::Column::Type::datetime: process(column.get_datetime(_p)); break;
	  case cppsas7bdat::Column::Type::date: process(column.get_date(_p)); break;
	  case cppsas7bdat::Column::Type::time: process(column.get_time(_p)); break;
	  }
	}
      }
