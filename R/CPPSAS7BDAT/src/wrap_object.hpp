...
namespace Rcpp {
  ...
  inline SEXP wrap_object(_Tp&& obj) { // inspired from "make_new_object" from Rcpp/Module.h
    Rcpp::XPtr<_Tp> xp( new _Tp(std::move(obj)), true ) ; // copy and mark as finalizable
